...
export function InvoiceForm({
  ...
  const [
    esolverRegistrationNumber,
    setEsolverRegistrationNumber,
  ] = useState(
  ...
  const [
    newCounterpartyEsolverCode,
    setNewCounterpartyEsolverCode,
  ] = useState("");

  const [
    newCounterpartyVat,
    setNewCounterpartyVat,
  ] = useState("");
  ...
  const [
    headerVatExemptReason,
    setHeaderVatExemptReason,
  ] = useState(
  ...
  const filteredCounterpartyOptions =
    useMemo(() => {
      ...
      return counterpartyOptions.filter(
        (company) => {
          const name =
  ...
  function recalcHeaderFromNetAndRate(
    net: string,
    rate: string,
    exempt: string,
  ) {
  ...
  function handlePdfSelected(
    ...
    startExtraction(
      async () => {
        const result =
          await extractInvoiceFromPdfAction(
            pdfFormData,
          );
      ...
      {mode === "create" && (
        <div className="app-card p-4 mb-4">
          ...
          <p className="text-muted small mb-3">
            Carica il PDF della
            fattura: i campi
            verranno precompilati
            automaticamente.
            Controlla sempre i dati
            prima di salvare.
          </p>
      ...
      >
        ...
        >
          ...
          <input
            type="hidden"
            name="amount_net"
            value={displayAmountNet.toFixed(
              2,
            )}
          />
          ...
          <input
            type="hidden"
            name="vat_amount"
            value={displayVatAmount.toFixed(
              2,
            )}
          />
          ...
          <input
            type="hidden"
            name="amount_total"
            value={displayAmountTotal.toFixed(
              2,
            )}
          />
          ...
          <div className="col-md-3">
            <label
              ...
              htmlFor="esolver-registration-number"
            >
              Progressivo eSolver
            </label>

            <input
              id="esolver-registration-number"
              aria-describedby="esolver-registration-help"
              name="esolver_registration_number_visible"
              className="form-control"
              value={
                esolverRegistrationNumber
              }
          ...
          <div className="col-md-8">
            ...
            >
              ...
              <option value="non_imponibile">
                Non imponibile
              </option>

              <option value="fuori_campo">
                Fuori campo
              </option>
          ...
          {!isNewCounterparty ? (
            <>
                  ...
                  >
                    <span className="text-truncate">
                      {selectedCounterparty
                        ? `${
                            selectedCounterparty.esolver_code
                              ? `${selectedCounterparty.esolver_code} - `
                              : ""
                          }${selectedCounterparty.business_name}`
                        : `Seleziona ${
                            invoiceType ===
                            "purchase"
                              ? "fornitore"
                  ...
                  >
                    <input
                      ...
                      placeholder={
                        invoiceType ===
                        "purchase"
                          ? "Cerca fornitore o codice eSolver..."
                          : "Cerca cliente o codice eSolver..."
                      }
                      value={
                        counterpartySearch
                      }
                    ...
                    0 ? (
                      ...
                      filteredCounterpartyOptions.map(
                        (
                          company,
                        ) => (
                          <button
              ...
              <div className="col-md-3">
                ...
                <input
                  className="form-control"
                  value={
                    selectedCounterparty?.vat_number ??
                    ""
                  }
                  readOnly
                  disabled
            ...
            <>
              ...
              <div className="col-md-4">
                ...
                <input
                  name="counterparty_new_esolver_code"
                  className="form-control"
                  value={
                    newCounterpartyEsolverCode
                  }
                  ...
                  placeholder="Codice anagrafica eSolver"
                />
              </div>
          ...
          <div className="col-12">
            ...
            <p className="text-muted small mb-2">
              {hasLines
                ? "Calcolati automaticamente dalle righe fattura."
                : "Nessuna riga: inserisci gli importi manualmente."}
            </p>
          </div>
          ...
          <label className="form-check mt-3">
            <input
              className="form-check-input"
              type="checkbox"
              name="acknowledge_pdf_duplicate"
              value="1"
            />
