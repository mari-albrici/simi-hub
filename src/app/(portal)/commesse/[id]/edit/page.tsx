...
export default async function EditProjectPage({
  ...
  const [customers, managers, entities, contacts] = await Promise.all([
        ...
        >
          ...
          <div className="col-md-6">
            ...
            <input
              name="cup"
              className="form-control"
              defaultValue={project.cup ?? ""}
              placeholder="Codice Unico di Progetto"
              autoComplete="off"
            />
          </div>
