...
export const PAGE_PERMISSIONS: Record<string, PermissionName> = {
  "/attivita": "task.read",
  "/anomalie": "anomaly.read",
  "/dashboard": "dashboard.read",
  "/commesse": "project.read",
  "/documenti": "document.read",
  "/fatture": "invoice.read",
  "/costi-gestionali": "management.read",
  "/pool-costi": "management.read",
  "/attrezzature": "management.read",
  "/container": "management.read",
  "/consumabili": "management.read",
  "/paghe": "payroll.summary.read",
  "/offerte": "offer.read",
  "/contratti": "contract.read",
  "/clienti": "company.read",
  "/fornitori": "company.read",
  "/scadenze": "deadline.read",
  "/personale": "employee.read",
  "/guide": "document.read",
  "/impostazioni": "admin.settings",
  "/aziende": "legal_entity.read",
  "/report": "report.read",
  "/pagamenti": "invoice.read",
  "/ordini": "order.read",
  "/ddt": "delivery_note.read",
};
