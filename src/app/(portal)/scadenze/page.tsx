...
export default async function Page({ searchParams }: { searchParams: Promise<Record<string, string | undefined>> }) {
    ...
    return <><div className="d-flex justify-content-between align-items-center gap-3 mb-3 flex-wrap">
  <h1 className="h3 mb-0">Scadenze</h1>
  ...
  <li>
    <a
      ...
      href="/api/scadenze/export?days=7"
    >
      Scadute + prossimi 7 giorni
    </a>
  </li>
  ...
  <li>
    <a
      className="dropdown-item"
      href="/api/scadenze/export?days=30"
    >
      Scadute + prossimi 30 giorni
    </a>
  </li>
  ...
  <li>
    <a
      className="dropdown-item"
      href="/api/scadenze/export?days=60"
    >
      Scadute + prossimi 60 giorni
    </a>
  </li>
  ...
  <li>
    <a
      className="dropdown-item"
      href="/api/scadenze/export?days=90"
    >
      Scadute + prossimi 90 giorni
    </a>
  </li>
</ul>
    </div>

    {hasPermission(user.role, "deadline.write") && (
      <Link
