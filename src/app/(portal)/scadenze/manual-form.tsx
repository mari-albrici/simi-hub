...
export async function ManualForm({record={},disabled=false}:{record?:Record<string,unknown>;disabled?:boolean}){
 ...
 return <form action={saveDeadline}><fieldset disabled={disabled} className="app-card p-3"><legend className="h5">Dati della scadenza</legend><input type="hidden" name="id" value={val("id")}/><div className="row g-3">
 ...
 <div className="col-12 mt-4"><h2 className="h5 border-top pt-3">Collegamenti e responsabilità</h2></div>
